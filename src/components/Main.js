    ...
    return (
      <div id="main" style={this.props.timeout ? { display: 'flex' } : { display: 'none' }}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{ display: 'none' }}>
          ...
          <p>My tools of choice include <a href="https://golang.org">Go</a>, <a href="https://clojure.org">Clojure</a><a href="https://clojurescript.org/">Script</a> and <a href="https://python.org">Python</a>, typically using <a href="https://www.tensorflow.org/">TensorFlow</a> for data science/modeling. I try to read a fair bit of <a href="https://haskell.org">Haskell</a>, and would love to work with it professionally but have not had the chance. I will read and write any code.</p>
          {close}
        </article>
